              ...
              <div className="max-w-5xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-8 text-gray-400 font-bold tracking-widest uppercase text-sm md:text-base">
                  ...
                  <motion.span 
                    ...
                    className="hidden md:inline-block w-1.5 h-1.5 bg-blue-600 rounded-full shadow-[0_0_10px_2px_rgba(37,99,235,0.6)]"
                  ></motion.span>
                  ...
                  <div className="space-y-10 mt-12 border-l-4 border-gray-200 pl-8">
                    ...
                    <div className="group">
                      ...
                      <div className="flex flex-col gap-4">
                        <a href="https://linkedin.com/company/orvanten-technology/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-600 hover:text-blue-600 transition-colors group/link">
                          <Linkedin size={28} className="transform group-hover/link:scale-110 transition-transform" />
                          <span className="text-xl md:text-2xl font-medium text-black">Orvanten Technology</span>
                        </a>
                        <a href="https://instagram.com/orvantentech" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-600 hover:text-pink-600 transition-colors group/link">
                          <Instagram size={28} className="transform group-hover/link:scale-110 transition-transform" />
                          <span className="text-xl md:text-2xl font-medium text-black">@orvantentech</span>
                        </a>
                        <a href="https://x.com/Orvanten" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-600 hover:text-black transition-colors group/link">
                          <Twitter size={28} className="transform group-hover/link:scale-110 transition-transform" />
                          <span className="text-xl md:text-2xl font-medium text-black">@Orvanten</span>
                        </a>
                      </div>
                    </div>
                  </div>
